/**
  ******************************************************************************
  * @file      startup_stm32h543xx.s
  * @author    MCD Application Team
  * @brief     STM32H553xx non-crypto devices vector table - GCC toolchain.
...
Reset_Handler:
  /* Set main stack pointer and limit */
...
/******************************************************************************
*
* The STM32H543xx vector table (RM0539 Table 152).
...
g_pfnVectors:
  ...
  .word 0                         
  .word 0                         
  .word PLAY1_IRQHandler          
  .word PLAY1_S_IRQHandler        
...
*******************************************************************************/
  ...
  .weak  PLAY1_IRQHandler
  .thumb_set PLAY1_IRQHandler,Default_Handler

  .weak  PLAY1_S_IRQHandler
  .thumb_set PLAY1_S_IRQHandler,Default_Handler
