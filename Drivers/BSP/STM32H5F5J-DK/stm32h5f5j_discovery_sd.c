/**
  ******************************************************************************
  * @file    stm32h5f5j_discovery_sd.c
  * @author  MCD Application Team
  * @brief   This file includes the uSD card driver mounted on STM32H5F5J_DK
  *          boards.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32H5F5J_DK_SD SD
  * @{
  */

/** @defgroup STM32H5F5J_DK_SD_Private_TypesDefinitions SD Private TypesDefinitions
  * @{
  */
...
/** @defgroup STM32H5F5J_DK_SD_Exported_Variables SD Exported Variables
  * @{
  */
...
/** @defgroup STM32H5F5J_DK_SD_Private_Variables SD Private Variables
  * @{
  */
...
/** @defgroup STM32H5F5J_DK_SD_Private_Functions_Prototypes SD Private Functions Prototypes
  * @{
  */
...
/** @defgroup STM32H5F5J_DK_SD_Exported_Functions SD Exported Functions
  * @{
  */
...
/** @defgroup STM32H5F5J_DK_SD_Private_Functions SD Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS > 0)
/**
...
static void SD_MspInit(SD_HandleTypeDef *hsd)
{
  ...
  if (hsd == &hsd_sdmmc[0])
  {
    ...
    /* GPIOC configuration */
    gpioinitstruct.Pin = GPIO_PIN_8 |GPIO_PIN_10|GPIO_PIN_11;
    HAL_GPIO_Init(GPIOC, &gpioinitstruct);

    gpioinitstruct.Mode      = GPIO_MODE_AF_PP;
    gpioinitstruct.Pull      = GPIO_PULLUP;
    gpioinitstruct.Speed     = GPIO_SPEED_FREQ_VERY_HIGH;
    gpioinitstruct.Alternate = GPIO_AF8_SDMMC1;
    ...
    HAL_GPIO_Init(GPIOK, &gpioinitstruct);
