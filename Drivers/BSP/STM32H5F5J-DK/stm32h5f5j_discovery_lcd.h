/**
  ******************************************************************************
  * @file    stm32h5f5j_discovery_lcd.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32h5f5j_discovery_lcd.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32H5F5J_DK_LCD_H
#define STM32H5F5J_DK_LCD_H
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
#ifndef USE_LCD_CTRL_ST1633I
#define USE_LCD_CTRL_ST1633I        1U
#endif /* USE_LCD_CTRL_ST1633i */

#if (USE_LCD_CTRL_ST1633I == 1)
/* Include ST1633i LCD Driver IC driver code */
#include "../Components/st1633i/st1633i.h"
#endif /* (USE_LCD_CTRL_ST1633I == 1) */
...
/** @addtogroup STM32H5F5J_DK_LCD
  * @{
  */

/** @defgroup STM32H5F5J_DK_LCD_Exported_Constants LCD Exported Constants
  * @{
  */
...
#define LCD_DISP_EN_PIN                      GPIO_PIN_6
#define LCD_DISP_EN_GPIO_PORT                GPIOF
#define LCD_DISP_EN_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOF_CLK_ENABLE()
#define LCD_DISP_EN_GPIO_CLK_DISABLE()       __HAL_RCC_GPIOF_CLK_DISABLE()

/* LCD Backlight Control pin*/
#define LCD_DISP_BL_PIN                      GPIO_PIN_3| GPIO_PIN_8;
#define LCD_DISP_BL_GPIO_PORT                GPIO
...
/**
  * @}
  */
/** @defgroup STM32H5F5J_DK_LCD_Exported_Types LCD Exported Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32H5F5J_DK_LCD_Exported_Functions
  * @{
  */
...
/* Private constants --------------------------------------------------------*/
/** @defgroup STM32H5F5J_DISCOVERY_LCD_Private_Constants Private Constants
  * @{
  */
/* Legacy defines */
