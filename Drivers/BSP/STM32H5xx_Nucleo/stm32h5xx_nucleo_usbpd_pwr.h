...
/* On STM32H5xx-Nucleo Kit (MB2129), following setup has been used :
      VSENSE      => PA11 */
#define VSENSE_GPIO_PORT                  GPIOA
#define VSENSE_GPIO_PIN                   LL_GPIO_PIN_11
#define VSENSE_GPIO_ENABLE_CLOCK()        LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOA);
#elif defined (STM32H553xx)
/* On STM32H5xx-Nucleo Kit (MB2321), following setup has been used :
      VSENSE      => PD4 */
#define VSENSE_GPIO_PORT                  GPIOD
#define VSENSE_GPIO_PIN                   LL_GPIO_PIN_4
#define VSENSE_GPIO_ENABLE_CLOCK()        LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD);
#else
...
/* PA4 and PA11 are used as ADC1_IN18 input for ADC measurement of VBUS voltage on NUCLEO-H563ZI and NUCLEO-H5E5ZJ, respectively :
   ADC1 Channel 18.
   Note: ADC-based VBUS sensing is not used on NUCLEO-H553ZG.
*/
...
#if defined (STM32H5E5xx)
/* Clock enabling for TCPP01 DB signal : PB9 */
...
#elif defined (STM32H553xx)
/* Clock enabling for TCPP01 DB signal : PG8 */
#define GPIO_TCPP01_DB_PORT               GPIOG
#define GPIO_TCPP01_DB_PIN                LL_GPIO_PIN_8
#define GPIO_TCPP01_DB_CLK_ENABLE()       LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOG);
#else
