...
#if defined(MCUBOOT_PRIMARY_ONLY)
  RE_IMAGE_FLASH_LOADER_OFFSET = (FLASH_AREA_LOADER_OFFSET),
  RE_IMAGE_FLASH_LOADER_ADDRESS = (FLASH_BASE_ADDRESS+FLASH_AREA_LOADER_OFFSET),
  RE_LOADER_S_CODE_SIZE = (LOADER_S_CODE_SIZE),
  RE_LOADER_WRP_START = (FLASH_AREA_LOADER_OFFSET),
  RE_LOADER_WRP_END = (FLASH_AREA_LOADER_OFFSET + LOADER_S_CODE_SIZE - 0x1),
#else
  RE_IMAGE_FLASH_LOADER_ADDRESS = (0x0),
  RE_LOADER_S_CODE_SIZE = (0x0),
#endif /* MCUBOOT_PRIMARY_ONLY */
...
#if defined(MCUBOOT_PRIMARY_ONLY)
  RE_BL2_SEC2_START = (FLASH_B_SIZE - LOADER_S_CODE_SIZE -0x1),
...
#else /* (FLASH_AREA_0_OFFSET+SECURE_IMAGE_MAX_SIZE) < (FLASH_B_SIZE) */
