...
%stm32programmercli% %connect_no_reset% -ob SRAM2_RST= SRAM2_ECC=
IF %errorlevel% NEQ 0 goto :error
...
%stm32programmercli% %connect_no_reset% -ob SECWM1_STRT= SECWM1_END=
IF %errorlevel% NEQ 0 goto :error
%stm32programmercli% %connect_no_reset% -ob SECWM2_STRT= SECWM2_END=
IF %errorlevel% NEQ 0 goto :error
