...
<label for="collapse-section10">V1.1.5 / 9-February-2026</label>
<div>
## Main Changes
...
### Python and some packages: See README.md

</div>
:::
::: {.collapse}
<input type="checkbox" id="collapse-section9" aria-hidden="true">
<label for="collapse-section9">V1.1.4 / 28-August-2025</label>
<div>
## Main Changes

### Removal of dll/exe (python based) for Windows. {#Removal-dll}

## Dependencies

### Python and some packages: See README.md {#python-package}

</div>
:::
::: {.collapse}
<input type="checkbox" id="collapse-section8" aria-hidden="true">
<label for="collapse-section8">V1.1.3 / 2-April-2024</label>
<div>
## Main Changes
